...
export const renderPingpongIcon = () =>
  html`<svg fill="currentColor" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 345.134 345.134" xml:space="preserve" stroke-width="11.389422" transform="rotate(0)matrix(-1, 0, 0, 1, 0, 0)" >
